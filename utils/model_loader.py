...
class ModelLoader:
    ...
    def _validate_env(self):
        ...
        Ensure API keys for HuggingFace and Groq are available in the environment.
        """

        required_vars=["HUGGINGFACEHUB_API_TOKEN","GROQ_API_KEY","GOOGLE_API_KEY"]
    ...
    def load_embeddings(self):
        ...
        try:
            ...
            return HuggingFaceEndpointEmbeddings(
                model=model_name,
                huggingfacehub_api_token=self.api_keys["HUGGINGFACEHUB_API_TOKEN"],
                )
...
if __name__ == "__main__":
    ...
    result=embeddings.embed_query("Capital of pakistan???")
    ...
    # Test the ModelLoader
    result=llm.invoke("Capital of pakistan???")
